...
namespace PokemonBattle
{
    public class TeamBuilder
    {
        public static void BuildTeam()
        {
            ...
            Thread.Sleep(1000);
            Console.Clear();
            Console.WriteLine($"Congratulations! You built your team with {pokemon1.Name}, {pokemon2.Name}, and {pokemon3.Name}!");
            //Emeny Team
            for (int i = 0; i < 3; i++)
            {
            ...
            Console.WriteLine($"Your enemy's team consists of {enemyTeam[0].Name}, {enemyTeam[1].Name}, and {enemyTeam[2].Name}!");
            Thread.Sleep(5000);
            Console.Clear();
        }
    }
